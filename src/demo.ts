...
export async function run3() {
  const imageBuffer = await readFile('/Users/cc/Desktop/dog.jpeg')
...
export async function run4() {
  const fileObj = await client.files.create({ file: fs.createReadStream('/Users/didi/Downloads/深度学习基础.pdf'), purpose: 'file-extract' as any })
